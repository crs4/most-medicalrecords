...
urlpatterns += patterns('most.web.medicalrecords.views.ehr',
    ...
    verb_url('GET',  r'^ehr/(?P<patient_uuid>.*)/records/(?P<record_uuid>.*)/$', 'get_ehr_record_for_patient'),
    verb_url('POST',   r'^ehr/(?P<patient_uuid>.*)/records/(?P<record_uuid>.*)/$', 'create_ehr_record_for_patient'),
    verb_url('POST', r'^ehr/(?P<patient_uuid>.*)/records/$', 'create_ehr_record_for_patient'),
    verb_url('DELETE', r'^ehr/(?P<patient_uuid>.*)/records/(?P<record_uuid>.*)/$', 'delete_ehr_record_for_patient'),
